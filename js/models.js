...
class StoryList {
  ...
  static async getStories() {
    ...
    //A static method is essentially the opposite of an instance method, since the two cases are mutually exclusive.
    //Instance methods rely on each object's specific data, while static methods must NOT rely on data from a specific object.
    //We call a static method by preceding it with the class name and using dot-notation.

    //getStories shouldn't be an instance method because we want to get all stories, regardless of an instance of the class StoryList
...
class User {
  ...
  static async signup(username, password, name) {
    ...
    return new User(
      ...
      //test user.token here; if it doesn't work, why can't i use it here?
      response.data.token
    );
  }
